...
public class MyOpenHelper extends SQLiteOpenHelper{
    ...
    private static final String CREATE_RECORD_TABLE = "create table recordTABLE (_id integer primary key, Date text, Sleep text, Breakfast text, Lunch text, Dinner text, TypeExercise text, TimeExercise text, DrinkWater text, Weight text, NameUser text);";
